...
func (*MatchedPlayers) ProtoMessage() {}

func (x *MatchedPlayers) ProtoReflect() protoreflect.Message {
	mi := &file_contract_protobuf_matching_matching_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use MatchedPlayers.ProtoReflect.Descriptor instead.
func (*MatchedPlayers) Descriptor() ([]byte, []int) {
	return file_contract_protobuf_matching_matching_proto_rawDescGZIP(), []int{0}
}

func (x *MatchedPlayers) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *MatchedPlayers) GetUserIds() []uint64 {
	if x != nil {
		return x.UserIds
	}
	return nil
...
var file_contract_protobuf_matching_matching_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x47, 0x0a, 0x0e, 0x4d,
	0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12, 0x1a, 0x0a,
	0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x19, 0x0a, 0x08, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x04, 0x52, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x73, 0x42, 0x1b, 0x5a, 0x19, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74,
	0x2f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e,
...
var file_contract_protobuf_matching_matching_proto_goTypes = []any{
	(*MatchedPlayers)(nil), // 0: MatchedPlayers
}
